...
class DecompilationService:
    ...
    def __init__(self, program: Program, logger: logging.Logger) -> None:
        """Initialize the decompilation service with Ghidra program and logger.
        ...
        self.logger = logger
        self.decompiler: Optional[DecompInterface] = None
        self._initialize_decompiler()

    def _initialize_decompiler(self) -> None:
        """Initialize the decompiler interface.
        
        Creates and configures a DecompInterface instance for the current program.
        Sets decompiler to None if initialization fails.
        
        Raises:
            DecompilationException: If decompiler initialization fails
        """
        try:
    ...
    def get_decompiled_function(self, function: Function) -> Optional[str]:
        """Get decompiled C code for a function using Ghidra's DecompInterface API.
        
        Args:
            function: Ghidra Function instance to decompile
            
        Returns:
            Decompiled C code as string, or None if decompilation fails
        """
    ...
    def _process_decompile_results(self, decompile_results: DecompileResults, function: Function) -> Optional[str]:
        ...
        Args:
            decompile_results: Results from Ghidra decompilation process
            function: Original function that was decompiled
            
        Returns:
            Cleaned decompiled C code, or None if processing fails
        """
    ...
    def get_function_calls_from_decompiled_code(self, decompiled_code: str) -> List[str]:
        """Extract function calls from decompiled C code using namespace utilities.
        
        Args:
            decompiled_code: C code string containing function calls to extract
            
        Returns:
            List of function names found in the decompiled code
        """
    ...
    def get_decompiled_functions(self, functions: List[Function]) -> Dict[str, Optional[str]]:
        """Get decompiled C code for multiple functions with duplicate filtering.
        
        Args:
            functions: List of Ghidra Function instances to decompile
            
        Returns:
            Dictionary mapping function names to their decompiled C code.
            Functions that fail to decompile have None values.
        """
    ...
    def cleanup(self) -> None:
        ...
        Flushes cache, closes program, and disposes of the DecompInterface
        to prevent memory leaks in long-running analysis sessions.
        """
        if self.decompiler:
            try:
