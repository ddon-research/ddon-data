...
{
    u8 OrderMaxNum;
    u8 ChargeAddOrderNum;
    u8 RewardBoxMaxNum;
    u16 CycleContentsPlaydataRemainDay;
};
...
struct CDataSetQuestDetail
{
    u32 ImageId;
    u32 ClearCount;
    u32 ClearCharacterNum;
    u32 BaseAreaPoint;
    u16 UndiscoveryGoldRatio;
    u16 UndiscoveryExpRatio;
    u16 UndiscoveryRimRatio;
    u16 LeaderCompleteNum;
    u16 RepeatRewardType;
    u8 RepeatRewardValue;
    u8 RepeatRewardCompleteNum;
    u8 RandomRewardNum;
    u8 ChargeRewardNum;
    u8 ProgressBonusNum;
    b8 IsDiscovery;
...
struct CDataQuestList
{
    ...
    MtTypedArray<CDataQuestEnemyInfo> QuestEnemyInfoList;
    MtTypedArray<CDataQuestLayoutFlagSetInfo> QuestLayoutFlagSetInfoList;
    MtTypedArray<CDataDeliveryItem> DeliveryItemList;
    b8 IsClientOrder;
};
...
CPacket_S2C_JOIN_LOBBY_QUEST_INFO_NOTICE S2C_JOIN_LOBBY_QUEST_INFO_NOTICE @0x00;