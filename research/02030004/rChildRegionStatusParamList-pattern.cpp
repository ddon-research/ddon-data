...
struct cChildRegionStatusParamList : MtObject
{
    rChildRegionStatusParam mpChildRegion;
    u32 mStatusNo;
    s32 mCheckPriority;
    s32 mWritePriority;
};

struct rChildRegionStatusParamList : rTbl2Base
{
    u32 mDataNum;
    cChildRegionStatusParamList mpData[mDataNum];
};

rChildRegionStatusParamList rchildregionstatusparamlist_at_0x00 @0x00;