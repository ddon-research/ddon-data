...
struct cPawnActInterMoveLightingAnchor : cPawnActInterBase
{
};

struct cPawnActInterMoveReksElement : cPawnActInterBase
{
};

struct cPawnActInterMoveAlchemyTrap : cPawnActInterBase
{
};
...
struct cPawnActInterSearchMaskPoint : cPawnActInterBase
{
};
...
struct cPawnActInterActMedalChange : cPawnActInterBase
{
  u32 mMedalActGroup;
};
...
struct cPawnAIActInter : cAIResource
{
    ...
    match(mpCmdInterDTIID) {
      (1272092900): cPawnActInterWait PawnActInterWait;
      (755114221): cPawnActInterRot PawnActInterRot;
      (1493314681): cPawnActInterMove PawnActInterMove;
      (933039616): cPawnActInterCliffClimb PawnActInterCliffClimb;
    }
};
...
struct cPawnAIAction : MtObject
{
    ...
    f32 mStaminaRateMin;
    f32 mStaminaRateMax;
    f32 mUseRateFromStaminaVeryLow;
    f32 mUseRateFromStaminaLow;
    f32 mUseRateFromStaminaMiddleLow;
    f32 mUseRateFromStaminaMiddleHigh;
    f32 mUseRateFromStaminaHigh;
    f32 mUseRateFromStaminaVeryHigh;
